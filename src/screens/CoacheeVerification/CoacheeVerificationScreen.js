  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={{ marginTop: 20, marginLeft: 20 }}>
        <HeaderComponent navigation={navigation} navigateTo={'ForgetPassword'} headerTitle={'Verification'} />
        <Image
      ...
      <View>
        ...
        >
          {`A 4-digit code has been sent to ${email} for your account verification`}
        </Text>
